# -*- coding: utf-8 -*-
"""
Created on Tue Jul 21 09:11:14 2026
...
ax.plot(B_values*B_c/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), model_parallel(B_values/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), *popt_parallel), "-b",  label=r"fit of $n_s(\gamma=0, \theta=0°)$", zorder=3)
...
# ax.plot(B_values*B_c/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), (superfluid_density_yy-superfluid_density_yy[0])/(superfluid_density_yy[0]+popt_parallel[0]), "bo",  label=r"fit of $n_s(\gamma=0, \theta=0°)$", zorder=3)
