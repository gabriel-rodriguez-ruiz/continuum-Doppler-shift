# -*- coding: utf-8 -*-
"""
Created on Tue Jul 21 11:26:58 2026
...
ax.plot(B_values/(0.5*mu_B*g), (superfluid_density_yy-superfluid_density_yy[0])/(superfluid_density_yy[0]+popt_parallel[0]), "b",  label=r"fit of $n_s(\gamma=0, \theta=0°)$", zorder=3)
