# -*- coding: utf-8 -*-
"""
Created on Sun Jul 26 23:25:39 2026
...
file_to_open = data_folder / "superfluid_density_Delta=0.08_lambda=15_points=60_N=500_T=True_beta=70_q_B_constant=0.003_Zeeman=False_theta=1.5707963267948966.npz"
...
B_c = 0.07  #Delta/(2*np.sqrt(gamma*mu)*q_B_constant)  # T
mu_B = 5.79e-2 # meV/T
...
ax.plot(B_values*B_c/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), 1/2*(model_parallel(B_values/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), *popt_parallel)+model_perpendicular(B_values/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), 1/scale_factor_perpendicular*popt_parallel[0],popt_parallel[1])),
        "--k")


ax.plot(B_values*B_c/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), 1/2*(model_parallel(B_values/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), *popt_parallel)+ 1/2*(model_parallel(B_values/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), *popt_parallel)+model_perpendicular(B_values/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), 1/scale_factor_perpendicular*popt_parallel[0],popt_parallel[1]))),
        "--k")
...
file_to_open = data_folder / "superfluid_density_Delta=0.08_lambda=15_points=60_N=500_T=True_beta=70_q_B_constant=0.0235921_Zeeman=True_theta=1.5707963267948966.npz"
...
initial_parameters_parallel = [  1.21976767e+05, 1]
popt_parallel, pcov_parallel = curve_fit(model_parallel, x_model_parallel, n_s_45[:41],
                                          p0=initial_parameters_parallel)
...
ax.plot(B_values/(0.5*mu_B*g),  1/2*(model_parallel(B_values, *popt_parallel)+model_perpendicular(B_values, 1/scale_factor_perpendicular*popt_parallel[0],popt_parallel[1])),
        "-k")


ax.plot(B_values/(0.5*mu_B*g), 1/2*(model_parallel(B_values, *popt_parallel)+ 1/2*(model_parallel(B_values, *popt_parallel)+model_perpendicular(B_values, 1/scale_factor_perpendicular*popt_parallel[0],popt_parallel[1]))),
        "-k")