...
# file_to_open = data_folder / "superfluid_density_B_in_1.6_beta_in_(14.506-1160.497)_phi_x_in_(-0.0-0.0)_lambda=15_points=19_N_phi=3_N=100_C=0_T=True_B=0.120865_Delta_0=0.122085656.npz"
file_to_open = data_folder / "superfluid_density_B_in_1.6_beta_in_(14.506-1160.497)_phi_x_in_(-0.0-0.0)_lambda=15_points=19_N_phi=3_N=100_C=0_T=True_B=0.077321_Delta_0=0.08139043733333334.npz"
...
# file_to_open = data_folder / "superfluid_density_B_in_1.6_beta_in_(14.506-1160.497)_phi_x_in_(-0.0-0.0)_lambda=15_points=19_N_phi=3_N=100_C=0_T=True_B=0.127_Delta_0=0.141043056.npz"
...
ax.plot(T_values, ((superfluid_density_finite_differences_perpendicular_0 - np.abs(superfluid_density_finite_differences_perpendicular_0[0]))/np.abs(superfluid_density_finite_differences_perpendicular_0[0])), "v-", label=r"perpendicular B=0.088",
            color="C3")
...
superfluid_density_yy_0 = Data["superfluid_density_yy_0"]
ax.plot(T_values, ((superfluid_density_yy_0-superfluid_density_yy_0[0])/superfluid_density_yy_0[0]), "o-", label=r"parallel B=0.088",
            color="C4")
...
ax.plot(T_values, alpha/2 * ( (Al_contribution + geometric_factor*(superfluid_density_yy_0 - superfluid_density_yy_0[0]) ) / ( 1 + geometric_factor*superfluid_density_yy_0[0] ) ) - 0.000525 , "o-")
ax.plot(T_values, alpha/2 * ( ( Al_contribution + anisotropic_factor*geometric_factor*(superfluid_density_finite_differences_perpendicular_0 - superfluid_density_finite_differences_perpendicular_0[0]) ) / ( 1 + anisotropic_factor*geometric_factor*np.abs(superfluid_density_finite_differences_perpendicular_0[0] ) ) ) - 0.0041 , "v-")
...
plt.tight_layout()
    ...
    #%% Relative difference respect to zero field
import pandas as pd
...
ax.errorbar(df_final["T 0mT"]/1000, df_final["Delta fr 0mT"]-df_final["Delta fr 0mT"][0], yerr=df_final['Delta fr err 0mT'], fmt='sk')
ax.errorbar(df_final["T 30mT 0°"]/1000, df_final["Delta fr 30mT 0°"]-df_final["Delta fr 30mT 0°"][0], yerr=df_final['Delta fr err 30mT 0°'], fmt='sr')
# ax.errorbar(df_final["T 30mT 90°"]/1000, df_final["Delta fr 30mT 90°"], yerr=df_final['Delta fr err 30mT 90°'], fmt='sr', markerfacecolor="None")
ax.errorbar(df_final["T 60mT 0°"]/1000, df_final["Delta fr 60mT 0°"]-df_final["Delta fr 60mT 0°"][0], yerr=df_final['Delta fr err 60mT 0°'], fmt='sb')
ax.errorbar(df_final["T 60mT 90°"]/1000, df_final["Delta fr 60mT 90°"]-df_final["Delta fr 60mT 90°"][0], yerr=df_final['Delta fr err 60mT 90°'], fmt='sb', markerfacecolor="None")
...
Al_contribution = np.tanh(Delta_0*1.74*np.sqrt(1-T/T_c)/(2*k_B*T)) - 1
ax.plot(T, Al_contribution)

T_c = 1.58  #1.86
Al_contribution = np.tanh(Delta_0*1.74*np.sqrt(1-T_values/T_c)/(2*k_B*T_values))
Al_stiffness = 600000   #300000
scale_factor = 5
# ax_BCS.plot(T_values, alpha/2 * ( Al_contribution + ((superfluid_density_yy_0-superfluid_density_yy_0[0])/(superfluid_density_yy_0[0]+Al_stiffness)) - 1), "o")
# ax_BCS.plot(T_values, alpha/2 * ( Al_contribution + ((superfluid_density_finite_differences_perpendicular_0-superfluid_density_finite_differences_perpendicular_0[0])/np.abs(superfluid_density_finite_differences_perpendicular_0[0] + Al_stiffness)) - 1), "v")
...
# ax.plot(T_values, alpha/2 * ( ( D_Al_T - D_Al_0 + superfluid_density_yy_0 - superfluid_density_yy_0[0] ) / ( D_Al_0 + superfluid_density_yy_0[0] ) ) - 0.000525 , "o-")
# ax.plot(T_values, alpha/2 * ( ( D_Al_T - D_Al_0 + scale_factor*(superfluid_density_finite_differences_perpendicular_0 - superfluid_density_finite_differences_perpendicular_0[0]) ) / ( D_Al_0 + scale_factor*np.abs(superfluid_density_finite_differences_perpendicular_0[0] ) ) ) - 0.0041 , "v-")
