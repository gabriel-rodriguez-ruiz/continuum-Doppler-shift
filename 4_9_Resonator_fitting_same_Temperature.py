# -*- coding: utf-8 -*-
"""
Created on Mon Jul 27 13:42:32 2026
...
B_c = 0.076  #Delta/(2*np.sqrt(gamma*mu)*q_B_constant)  # T
mu_B = 5.79e-2 # meV/T
...
ax.plot(B_values/Delta*B_c, 1/2*(model_parallel(B_values/Delta, *popt_parallel)+ 1/2*(model_parallel(B_values/Delta, *popt_parallel)+model_perpendicular(B_values/Delta, 1/scale_factor_perpendicular*popt_parallel))),
        "-.k")
...
mu_B = 5.79e-2  # meV/T
g = 3.47725  #3.47725  #11.4923#17.24
...
ax.plot(B_values/(0.5*mu_B*g),  1/2*(model_parallel(B_values, *popt_parallel)+model_perpendicular(B_values, 1/scale_factor_perpendicular*popt_parallel)),
        "-r")
...
# ax.plot(B_values/(0.5*mu_B*g), 1/2*(model_parallel(B_values, *popt_parallel)+ 1/2*(model_parallel(B_values, *popt_parallel)+model_perpendicular(B_values, 1/scale_factor_perpendicular*popt_parallel))),
#         "-r")