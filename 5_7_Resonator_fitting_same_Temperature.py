...
ax.plot(B_values*B_c/(Delta/(2*np.sqrt(gamma*mu)*q_B_constant)), (superfluid_density_yy-superfluid_density_yy[0])/(superfluid_density_yy[0]+popt_parallel[0]), "--k")
...
initial_parameters_parallel = [ 114190]
popt_parallel, pcov_parallel = curve_fit(model_parallel, x_model_parallel, n_s_0[:41],
                                          p0=initial_parameters_parallel)
...
x_model_parallel  = field_0[:41] * 0.5*mu_B*g
x_model_perpendicular  = field_90[:41] *0.5*mu_B*g
...
ax.plot(B_values/(0.5*mu_B*g), (superfluid_density_yy-superfluid_density_yy[0])/(superfluid_density_yy[0]+popt_parallel[0]), "-k")
