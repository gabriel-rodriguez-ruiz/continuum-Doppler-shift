...
# I use kBT/(2Delta) because half of the gap was considered.
ax.plot(B_values/Delta, alpha/2*(Aluminum_contribution-Aluminum_contribution_0+gamma*(superfluid_density_xx-gas_reference))/(Aluminum_contribution_0+gamma*gas_reference), "v-", label=r"perpendicular $\frac{k_BT}{\Delta_0}$" + f"={np.round((k_B*T/0.16), 3)}", fillstyle="none")
...
ax.plot(B_values/Delta, alpha/2*(Aluminum_contribution-Aluminum_contribution_0+gamma*(superfluid_density_yy-gas_reference))/(Aluminum_contribution_0+gamma*gas_reference), "o--", label=r"parallel $\frac{k_BT}{\Delta_0}$" + f"={np.round((k_B*T/0.16), 3)}")
...
# ax.plot(B_values/Delta, superfluid_density_xx, "v-", label="perpendicular")
# ax.plot(B_values/Delta, (superfluid_density_xx-superfluid_density_xx[0])/superfluid_density_xx[0], "v-", label="perpendicular")
ax.plot(B_values/Delta, alpha/2*(Aluminum_contribution-Aluminum_contribution_0+gamma*(superfluid_density_xx-gas_reference))/(Aluminum_contribution_0+gamma*gas_reference), "v-", label=r"perpendicular $\frac{k_BT}{\Delta_0}$" + f"={np.round((1/(beta*0.16)), 3)}", fillstyle="none")

# ax.plot(B_values/Delta, superfluid_density_yy, "o-", label="parallel")
# ax.plot(B_values/Delta, (superfluid_density_yy-superfluid_density_yy[0])/superfluid_density_yy[0], "o-", label="parallel")
ax.plot(B_values/Delta, alpha/2*(Aluminum_contribution-Aluminum_contribution_0+gamma*(superfluid_density_yy-gas_reference))/(Aluminum_contribution_0+gamma*gas_reference), "o--", label=r"parallel $\frac{k_BT}{\Delta_0}$" + f"={np.round((1/(beta*0.16)), 3)}")
