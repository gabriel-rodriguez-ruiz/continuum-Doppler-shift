# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 10:18:11 2026
...
# file_to_open = data_folder / "superfluid_density_Delta=0.08_lambda=15_points=60_N=500_T=True_beta=50_q_B_constant=0.0235921_Zeeman=True_theta=1.5707963267948966.npz"
...
ax.plot(B_values/(0.5*mu_B*g), model_parallel(B_values, *popt_parallel), "-b",  label=r"fit of $n_s(\gamma=0, \theta=0°)$", zorder=3)
...
# ax.plot(B_values/(0.5*mu_B*g), (superfluid_density_yy-superfluid_density_yy[0])/(superfluid_density_yy[0]+popt_parallel[0]), "bo",  label=r"fit of $n_s(\gamma=0, \theta=0°)$", zorder=3)
...
# ax.plot(B_values/(0.5*mu_B*g),  ( (superfluid_density_xx-superfluid_density_xx[0])/(superfluid_density_xx[0]+ 1/scale_factor_perpendicular*popt_parallel[0])),
#         "--ko",  label=r"fit of $n_s(\gamma=0, \theta=90°)$")
...
# ax.plot(B_values/(0.5*mu_B*g),  1/2*( (superfluid_density_xx-superfluid_density_xx[0])/(superfluid_density_xx[0]+ 1/scale_factor_perpendicular*popt_parallel[0]) + (superfluid_density_yy-superfluid_density_yy[0])/(superfluid_density_yy[0]+ popt_parallel[0])),
